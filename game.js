// Конфігурація гри
var config = {
    type: Phaser.AUTO, // Тип рендерингу
    width: 800, // Ширина вікна гри
    height: 600, // Висота вікна гри
    physics: {
        default: 'arcade', // Використання аркадної фізики
        arcade: {
            gravity: { y: 300 }, // Гравітація
            debug: false // Відображення дебаг-інформації
        }
    },
    scene: {
        preload: preload, // Функція завантаження ресурсів
        create: create, // Функція створення об'єктів у грі
        update: update // Функція оновлення гри
    }
};
...
{
    // Функція для обробки зіткнення з бомбою
    this.physics.pause();
